package in.co.equations.filters;
...
public class AuthenticationFilter implements Filter {
	...
	*/
	...
	try {
            ...
            boolean loggedIn = httpSession.getAttribute("userSession") != null ? true: false;
            boolean loginPage = url.endsWith("/login.page");
            boolean loginSubmit = url.endsWith("loginSubmit.page");
            System.out.println(loginPage);
            System.out.println(loginSubmit);
            if (!loggedIn && !loginPage) {
                httpResponse.sendRedirect("/login.page");
            } else if (loggedIn && (loginPage || loginSubmit)) {
                httpResponse.sendRedirect("/admin/user/create.form");
            } else {
