<link rel="stylesheet" type="text/css" href="/resources/css/contents/bottom.css" />
    ...
    <div id="bottom_snippet_right">
        <div id="botton_snippet_left">
            <table border="0">
                <tbody>
                    <tr>
                        <td width="45%">Director</td>
                        <td>Deepak Dutt Mamgain</td>
                    </tr>
                    <tr>
                        <td>Contact No</td>
                        <td>+91-9219655426, +91-9411575426</td>
                    </tr>
                    <tr>
                        <td>Address</td>
