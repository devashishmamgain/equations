...
<html>
    ...
    <body>
        ...
        <div id="main_content">
            ...
            <script type="text/javascript" src ="/resources/i18n/jquery.ui.datepicker-en.min.js"></script>

            <script type="text/javascript">
                function formatLink(cellvalue, options, rowObject) { return "<a href='"+cellvalue +"'>"+cellvalue+"</a>"; }
            </script>

            <div id="notificationList"></div>

            <s:url id="findAll" value="/notification/list.action" />
            <c:choose>
                <c:when test="${loggedIn == 'true'}">
                    <s:url id="editNotification" value="/admin/notification/crud.action" />
